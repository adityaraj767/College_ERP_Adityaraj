...
from .models import Attendance, Session, Subject, CustomUser

DEFAULT_ADMIN_EMAIL = "adityarajyadav030@gmail.com"
DEFAULT_ADMIN_PASSWORD = "adityaraj767"
DEFAULT_ADMIN_PIC = "default_admin.png"


def ensure_default_admin():
    try:
        user = CustomUser.objects.filter(email=DEFAULT_ADMIN_EMAIL).first()
        if not user:
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            if passport:
                ...
                passport_url = DEFAULT_ADMIN_PIC
            try:
